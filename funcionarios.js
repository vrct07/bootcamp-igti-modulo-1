...
function nomeMaiorSalario(){
  fs.readFile(nomeArquivo,"utf-8",function(err,data){
    if (err){
     ...
     //console.log("Nome do funcionário que tem o MAIOR salário da Empresa: " + nomeMaiorSalario +", com salario = "+ maiorSalEmp);
     document.getElementById("resultado").innerHTML = "Seu IMC é: " + nomeMaiorSalario +", com salario = "+ maiorSalEmp;
    }
  });
}
